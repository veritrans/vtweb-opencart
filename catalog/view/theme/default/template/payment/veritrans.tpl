<?php if (count($errors) > 0): ?>
  ...
  <?php endforeach ?>
<?php else: ?>
  <?php if ($this->config->get('veritrans_api_version') == 1 && $this->config->get('veritrans_payment_type') == 'vtweb'): ?>
  ...
  <?php elseif ($this->config->get('veritrans_api_version') == 2 && $this->config->get('veritrans_payment_type') == 'vtweb'): ?>
        ...
        $(function() {
          $.getScript('https://payments.veritrans.co.id/vtdirect/veritrans.min.js')
            .done(function() {
              ...
              $("#payment-form")[0].submit(function(event){
